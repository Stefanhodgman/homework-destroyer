--[[
	RemoteEvents.lua (UPDATED VERSION - Replace original with this)
	...
	UPDATED: Added comprehensive zone management remote events
]]
...
local REMOTE_CONFIGS = {
	...
	-- Zone Events (UPDATED - Comprehensive zone management)
	{
		Name = "RequestZoneUnlock",
		Type = "Event",
		Description = "Request to unlock a new zone",
		Parameters = "zoneID"
	},
	{
		Name = "RequestZoneTeleport",
		Type = "Event",
		Description = "Request to teleport to an unlocked zone",
		Parameters = "zoneID"
	},
	{
		Name = "RequestZoneInfo",
		Type = "Event",
		Description = "Request detailed information about a zone",
		Parameters = "zoneID"
	},
	{
		Name = "GetUnlockedZones",
		Type = "Event",
		Description = "Request list of all unlocked zones",
		Parameters = "none"
	},
	{
		Name = "ReceiveZoneInfo",
		Type = "Event",
		Description = "Server sends zone information to client",
		Parameters = "zoneInfo (table)"
	},
	{
		Name = "ReceiveUnlockedZones",
		Type = "Event",
		Description = "Server sends list of unlocked zones to client",
		Parameters = "unlockedZones (array)"
	},
	{
		Name = "ZoneUnlockResult",
		Type = "Event",
		Description = "Server notifies client of zone unlock result",
		Parameters = "success (boolean), message (string)"
	},
	{
		Name = "ZoneTeleportResult",
		Type = "Event",
		Description = "Server notifies client of teleport result",
		Parameters = "success (boolean), message (string)"
	},
...
-- Quick access functions for commonly used events (UPDATED with zone events)
function RemoteEvents.Get()
	...
	return {
		...
		-- Zones (UPDATED)
		RequestZoneUnlock = RemoteEvents.GetEvent("RequestZoneUnlock"),
		RequestZoneTeleport = RemoteEvents.GetEvent("RequestZoneTeleport"),
		RequestZoneInfo = RemoteEvents.GetEvent("RequestZoneInfo"),
		GetUnlockedZones = RemoteEvents.GetEvent("GetUnlockedZones"),
		ReceiveZoneInfo = RemoteEvents.GetEvent("ReceiveZoneInfo"),
		ReceiveUnlockedZones = RemoteEvents.GetEvent("ReceiveUnlockedZones"),
		ZoneUnlockResult = RemoteEvents.GetEvent("ZoneUnlockResult"),
		ZoneTeleportResult = RemoteEvents.GetEvent("ZoneTeleportResult"),
